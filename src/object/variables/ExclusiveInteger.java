 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ExclusiveInteger extends ExclusiveVariable {
	...
	public void set(int value) throws ExcludedException, RTIexception {
	...
	/* (non-Javadoc)
	 * @see hla_past.object.PublicVariable#getBytes()
	 */
	...
	/* (non-Javadoc)
	 * @see hla_past.object.PublicVariable#update(byte[])
	 */
